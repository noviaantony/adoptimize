        ...
        {heroSlider.map((slide, index) => {
          ...
          return (
            <SwiperSlide className='py-12 lg:py-16' key={index}>
              <div className='container mx-auto text-center lg:text-left font-nunito'>
                <div className='flex flex-col justify-between items-center lg:flex-row'>
                  <div className='flex-1'>
                    ...
                    <button className='btn  mb-8 lg:mb-0 px-7 py-2 w-full bg-[#050a30] text-center rounded-md block sm:w-auto font-bold hover:bg-gray-700 hover:text-white text-white'>
                      {buttonText}
                    </button>
                  </div>
