...
const Hero = () => {
  ...
  return (
    <section className='min-h-[900px] py-12 font-nunito text-[#050a30] '>
      <div className='container mx-auto min-h-[900px] flex justify-center items-center'>
        <div className='flex flex-col lg:gap-x-[30px] gap-y-8 lg:gap-y-0 lg:flex-row items-center justify-center text-center lg:text-left'>
          ...
          >
            <h1
              className='ext-6xl lg:text-8xl font-extrabold mb-6 font-bold mb-2 lg:mb-5'
            >
            ...
            <p
              ...
              data-aos-delay='600'
            >
              streamlining and digitalizing pet adoption for both shelters and adopters
            </p>
            {/* btn & comp text */}
            <div
              ...
              data-aos-delay='700'
            >
              <Link className="bg-[#050a30] focus:bg-primary-700 focus:text-gray-200 focus:shadow-outline focus:outline-none transition duration-300
                px-7 py-2 w-full bg-[#050a30] text-center rounded-md block sm:w-auto font-bold hover:bg-blue-900 hover:text-white text-white font-nunito" to="/SignUp">
                  Get Started
              </Link>
            </div>
            </motion.div>
