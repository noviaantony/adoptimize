  ...
  const adoptionData = [
    {
      ...
      info: 'link',
      state: 'Pre-adoption Checks', // options: Collection, Pending Interview, Pending Home Check, Completed,
      documents:'link',
    ...
    },
    {
      ...
      contact: '+65 1234 5678',
      info: 'link',
      state: 'Pending Collection', // options: Collection, Pending Interview, Pending Home Check, Completed,
      documents:'link',
