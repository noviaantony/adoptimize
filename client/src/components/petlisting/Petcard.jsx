                                ...
                                <div className="relative p-6 flex-auto">
                                    <p className="my-4 text-gray-700 text-lg leading-relaxed">
                                        <Collapse defaultActiveKey={['1']} onChange={onCollapseChange}>
                                            ...
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi eveniet, totam aspernatur nihil, ut cumque possimus quisquam nemo illo vel commodi sapiente facere quis? Cum, laborum maxime aperiam commodi modi fugiat ab eius corrupti! Sunt illum accusamus debitis, impedit perferendis porro. Deserunt impedit corporis vitae eaque sapiente cum minima temporibus?</p>
                                            </Panel>
                                            <Panel header="Medical Details" key="6">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis odio quisquam expedita commodi, voluptatem earum. Beatae tenetur fugit officiis! Dolorem quibusdam rem sit ducimus cupiditate adipisci voluptatem dolorum inventore perferendis repellat accusantium facilis, mollitia eaque at nulla incidunt modi nesciunt eius exercitationem, voluptate rerum. Dolorum iusto veniam maxime deserunt corporis.</p>
                                            </Panel>
                                            <Panel header="Adopter Requirement" key="7">
                                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fuga, voluptas iusto! Voluptates facilis vel, maiores excepturi facere reiciendis corrupti distinctio.</p>
                                            </Panel>
