                    ...
                    <div className="relative w-auto my-6 mx-auto max-w-3xl">
                      ...
                      <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="text-center items-start justify-between p-3 border-b border-solid border-slate-200 rounded-t mt-5">
                          <h3 className="text-3xl font-semibold mx-32">
                            Add New Pet to Adoptsy!
                          </h3>
                          <button
                              ...
                              <Accordion open={open === 4}>
                                ...
                                <AccordionBody>
                                  <input
                                    ...
                                    id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-nunito"
                                    placeholder="Add a detailed description about the pet's personality"
                                  />
                                </AccordionBody>
                              </Accordion>
                              <Accordion open={open === 5}>
                                ...
                                <AccordionBody>
                                  <input
                                    ...
                                    id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-nunito"
                                    placeholder="Add information on the pet's medical history (eg: Vaccinated/Mircochipped"
                                  />
                                </AccordionBody>
                              </Accordion>
                              <Accordion open={open === 6}>
                                ...
                                <AccordionBody>
                                  <input
                                    ...
                                    id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-nunito"
                                    placeholder="Enter specific requiements for adopters"
                                  />
                                </AccordionBody>
                              </Accordion>
                              ...
                              <Accordion open={open === 7}>
                                ...
                                <AccordionBody>
                                  <input
                                    ...
                                    id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-nunito"
                                    placeholder="Enter full adoption fee"
                                  />
                                </AccordionBody>
                              </Accordion>

                              <p className="my-4 text-gray-700 text-lg leading-relaxed font-bold">
                                Upload Pet Pictures:
                              </p>
                              <input
