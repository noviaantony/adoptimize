...
//        import com.AdoptEasy.AdoptionContract.AdoptionContractFileNotFoundException;
        import com.AdoptEasy.AdoptionContract.AdoptionContractService;
...
public class AdoptionContractController {
    ...
    public String listUploadedFiles(Model model) throws IOException {
        ...
        model.addAttribute("files", adoptionContractService.loadAll().map(
                        path -> MvcUriComponentsBuilder.fromMethodName(AdoptionContractController.class,
    ...
    public ResponseEntity<Resource> serveFile(@PathVariable String filename) {
        ...
        Resource file = adoptionContractService.loadAsResource(filename);
    ...
    public String handleFileUpload(@RequestParam("file") MultipartFile file,
        ...
        adoptionContractService.store(file);
