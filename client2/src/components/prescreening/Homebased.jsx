...
const homeBasedQuestions = [
  ...
  {
    question: "Do you have a backyard or outdoor space?",
    type: "multipleChoice",
    choices: ["Yes", "No"],
  },
];
...
const Homebased = () => {
  const [checkedList, setCheckedList] = useState(
    new Array(homeBasedQuestions.length).fill(false)
  );
  ...
  return (
    <>
      <div className="font-nunito">
        {homeBasedQuestions.map((question, index) => (
          <div
            key={index}
